...
void UInventoryComponent::ToggleInventory()
{
    ...
    if (OnInventoryToggled.IsBound())
    {
        UE_LOG(LogTemp, Warning, TEXT(" OnInventoryToggled HAS Listeners!"));
    }
    else
    {
        UE_LOG(LogTemp, Error, TEXT(" OnInventoryToggled has NO Listeners!"));
    }
...
void UInventoryComponent::MoveSelection(int32 Direction)
{
    ...
    OnSelectionChanged.Broadcast(CurrentSelectedSlot);
}
